...
{
  "module": "charlie.json",
  "role": "Minimal JSON encoder and parser for CharlieJSON",
  "exports": {
    ...
    "null":      "sentinel  JSON null; use instead of Lua nil when building CharlieJSON tables",
...
--[[ { "what": "JSON null sentinel", "why": "Lua nil cannot be stored in tables; use this wherever JSON null is needed in CharlieJSON output" } ]]
