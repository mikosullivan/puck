--[[
{
  ...
  "covers": "smoke-tests: parse + transpile all 7 .dc example files without error; to_json round-trip (compact and pretty)",
...
local src_base = "./tests/examples/"

for _, name in ipairs(examples) do
    local path = src_base .. name .. ".dc"
    runner.test(name .. ".dc parses and transpiles", function()
        ...
        -- Every .dc file has at least one statement.
