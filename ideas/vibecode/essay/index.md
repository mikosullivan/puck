...
- [midsummer.txt](https://puck.uno/ideas/vibecode/essay/midsummer.txt) — 74,558 chars of prose
- [midsummer.json](https://puck.uno/ideas/vibecode/essay/midsummer.json) — 33,817 chars of vibecode (45% the size on disk) covering the same content
