...
Removed from the bootstrap doc's example-hosts list ([engine-creation § Examples of hosts](https://puck.uno/requirements/bootstrap/engine-creation#examples-of-hosts)). When V1 host enumeration evolves, this idea page is the placeholder.
