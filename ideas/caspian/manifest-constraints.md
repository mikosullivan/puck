...
{"vibecode": {
	...
	"related_spec": "https://puck.uno/requirements/engine/manifest"
}}
~~~
...
- [`%engine.manifest`](https://puck.uno/requirements/engine/manifest) — the runtime report half, which stays in V1.0.
- [Caspian versioning](https://puck.uno/requirements/versioning/) — how a program selects which version of a library to look up. Adjacent to the constraints-file concern.
- [Downloads / `%fetch` sources](https://puck.uno/requirements/downloads/) — the fetch-and-cache layer where library version choices manifest at runtime.
