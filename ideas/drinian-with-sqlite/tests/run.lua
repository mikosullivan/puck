...
--[[ {
	"vibecode": {
		"role": "test runner for the drinian-with-sqlite prototype. Globs test_*.lua files in this directory and runs each. Self-contained under ideas/drinian-with-sqlite/ per spec-before-implementation."
	}
} ]]
...
package.path = script_dir .. '../src/?.lua;' .. script_dir .. '?.lua;'
