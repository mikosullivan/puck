...
- **The full call stack** (potentially all of [Drinian](https://puck.uno/requirements/drinian/)) — every frame, every owning role, every local variable, every cross-role transition.
...
- [Drinian](https://puck.uno/requirements/drinian/) — the process-state introspection format the agent would presumably read to understand the live context.
