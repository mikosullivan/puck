...
- [Puckai spec](https://puck.uno/requirements/ecoverse/puckai/) — the worldlet format skills attach to.
- [Puckai bootstrap](https://puck.uno/requirements/ecoverse/puckai/bootstrap/) — the one-source-two-forms model that the skill URL-vs-inline shape mirrors.
- [Agent guidance in worldlet vibecode](https://puck.uno/requirements/ecoverse/puckai/#agent-guidance) — the sibling vibecode key for simpler one-line behavior hints.
