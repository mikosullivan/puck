...
- **Set operations on arrays** — `∪`, `∩`, `△`, `⊂`, `⊆` all work no-dot. See [array-methods § Set operations](https://puck.uno/ideas/array-methods#set-operations).
...
- **Assignment aware methods** ([ideas/assignment-aware-methods](https://puck.uno/ideas/assignment-aware-methods)) — separate concept about `.field = value` triggering a method. Not related.

## Related

- [array-methods § Set operations](https://puck.uno/ideas/array-methods#set-operations) — the first concrete surface exercising this, and the reason this idea exists.
