...
**Included in V1.** All design decisions on this page are now spec'd at [built-in-classes/object/methods/ § `.tap`](https://puck.uno/requirements/built-in-classes/object/methods/#tap). This brainstorm is kept as a design record; nothing here is still under consideration.
...
folded into the [object-methods spec](https://puck.uno/requirements/built-in-classes/object/methods/#tap) 2026-07-05.
