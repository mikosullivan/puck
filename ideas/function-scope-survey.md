...
Caspian's current design lives at [functions/bare](https://puck.uno/requirements/functions/bare). This survey does not evaluate it — it just maps the neighborhood.
