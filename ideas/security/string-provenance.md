...
The coarse model of one role-tag per value (see [roles.md](../requirements/roles.md)) collapses
...
- **Scope.** Does provenance apply only to strings, or also to numbers, hashes,
  ...
  (see the container-vs-contents principle in [roles.md](../requirements/roles.md)).
