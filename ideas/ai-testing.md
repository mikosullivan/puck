...
- [Puckai](https://puck.uno/requirements/ecoverse/puckai/) — worldlet-based agent collaboration; testing Puckai-using code has similar needs.
- [Bryton (Caspian test framework)](https://puck.uno/requirements/packages/bryton/) — wherever a built-in mock-agent helper eventually lands, Bryton is likely its home.
