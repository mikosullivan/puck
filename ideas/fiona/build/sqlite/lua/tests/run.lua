#!/usr/bin/env lua5.4
-- Test runner for the Fiona Lua-interface tests. Discovers every
-- test_*.lua file next to this runner and executes it in order. Each file
-- registers its tests via helpers.test(); after all files run, reports
