...
{"vibecode": {
	...
	"role": "Live-rendered view of the Fiona SQLite schema. Sources of truth are ../../build/lua/src/fiona.sql (persistent) and ../../build/lua/src/fiona-temp.sql (per-connection temp tables). This page reads both on every render so edits show up immediately.",
...
<!-- file: ../../build/lua/src/fiona-temp.sql -->
