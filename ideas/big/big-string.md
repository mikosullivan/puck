...
5. **Snapshot / revive.** How does a bigstring survive a CVM snapshot? The referenced file exists in the host filesystem, not the runtime's own memory. Snapshot the file path? Snapshot the whole file? Fail on serialization?
