...
- The runner being itself a Caspian program — V0.1 runner is
...
internals; that's fixed at V0.01. Bryton is for testing **Caspian
code with Caspian code** (or, in V0.1, with any script that emits
...
"v00X_caspian_text_parser_and_transpiler_so_test_files_can_be_caspian_source",
"v00X_hash_class_so_caspian_tests_can_construct_xemes",
"v00X_stdout_writing_so_caspian_tests_can_emit_xemes",
...
|---|---|
| Engine can run CaspianJ end-to-end | V0.01 |
| Caspian text → CaspianJ transpiler | V0.02 |
...
| Caspian CLI executable (`caspian` command, shebang support, permission flags) | [V0.0X CLI slice](v0.0x.md) |
...
prerequisites land — Caspian files). For V0.1 acceptance, the
