...
**Peaseblossom is the client-side library for puck.uno.** Site-specific CSS, JavaScript, and HTML patterns the site itself uses — distinct from the general-purpose patterns in [jqmin/](../jqmin/jqmin.md) that the world could use. Things land in Peaseblossom because they only make sense in the context of *this* site; things land in jqmin because they could plausibly be useful to someone building a different site.
