...
- **Cross-doc link integrity** — Corin's bootstrap.md links (three sites, all referencing `§ stdout and stderr`) resolve correctly after the recent bootstrap.md promotion to `requirements/caspian/`.
