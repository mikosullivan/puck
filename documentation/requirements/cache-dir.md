...
- [`%fetch`](https://puck.uno/documentation/requirements/chain/methods/puck) — the Caspian-side gateway for fetches. `%fetch`'s search path (spec'd elsewhere) is where a cache directory sits.
