...
- [Faucets](https://puck.uno/documentation/requirements/plumbing/faucets/) — inbound edge; role-tagging of pulled values; narrowed-faucets rule.
- [Sinks](https://puck.uno/documentation/requirements/plumbing/sinks/) — outbound edge; sinks are just objects; holding-is-access; engine as the only outbound gateway.
