...
- One role per engine-provided faucet, with the narrowing rules that come with it (see [plumbing/faucets](https://puck.uno/documentation/requirements/plumbing/faucets/)).
