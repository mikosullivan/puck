...
```
$agent = %['puck.uno/ai/agent'].new('https://foo.bar/gup')
```

The URL is the agent's network address — where requests are sent. It is a plain URL, not a UNS; use the full scheme-prefixed form (`https://...`).
