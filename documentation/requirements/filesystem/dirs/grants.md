...
- [dirs § .cd()](https://puck.uno/documentation/requirements/filesystem/dirs/#cd) — one of the current nanny methods this spec grants.
- [linux-support § Executing from a directory](https://puck.uno/documentation/requirements/linux-support/#executing-from-a-directory) — `.execute_in`, the other current nanny method.
- [%fs](https://puck.uno/documentation/requirements/global-methods/fs) — where `.dirjail(...)` (which grants extend) is spec'd.
- [concepts § Security](https://puck.uno/documentation/requirements/concepts#security) — the holding-is-access rule that grants slot into.
