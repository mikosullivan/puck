...
The [`.object.isa?`](https://puck.uno/documentation/requirements/built-in-classes/object/methods/#isaclass) method is the standard way to branch on class; it's subclass-inclusive too, so the branches read the same way `catch` filters do.
