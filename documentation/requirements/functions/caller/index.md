...
Both string keys (`$caller['foo']`) and symbol keys (`$caller[:foo]`) work — the symbol notation is [sugar for identifier-shaped strings](https://puck.uno/documentation/requirements/built-in-classes/primitives/string/#literal-forms).
