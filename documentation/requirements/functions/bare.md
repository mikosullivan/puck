...
- **What's reachable.** Only the arguments passed in (via the parameter list), the names defined locally within the body, and [`%chain`](https://puck.uno/documentation/requirements/chain/).
