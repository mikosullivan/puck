...
~~~vibecode
{"vibecode": {
	"doc": "requirements_built_in_string",
...
| `.length` | Returns the number of characters as a [number](https://puck.uno/documentation/requirements/built-in-classes/primitives/number/). |
...
Parse a string into a number. Each method parses the string's content (prefix-aware: `"0x..."`, `"0o..."`, `"0b..."` are recognized as their respective bases; no prefix is treated as decimal) and returns the result as the corresponding [number](https://puck.uno/documentation/requirements/built-in-classes/number/) subclass:
...
- [Roles § Objects also have roles](https://puck.uno/documentation/requirements/roles/#objects-also-have-roles) — every string instance carries an owning role, set at creation.
