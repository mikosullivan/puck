...
`null` is one of the two **falsy** values (the other is `false`). Full rules at [syntax § Truthy and falsy](https://puck.uno/documentation/requirements/syntax/truthy-and-falsy).
...
- [Syntax § Truthy and falsy](https://puck.uno/documentation/requirements/syntax/truthy-and-falsy) — how null composes with the truthy/falsy rule.
