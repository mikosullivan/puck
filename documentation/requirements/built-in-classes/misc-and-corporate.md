...
- [bucket-access](https://puck.uno/documentation/requirements/built-in-classes/bucket-access) — the parallel utility classes for the whole bucket via `[]` / `[]=`.
- [object/structure § Bucket](https://puck.uno/documentation/requirements/built-in-classes/object/structure/#bucket) — what the bucket is and how the pass-through fields fit into the object structure.
