...
~~~vibecode
{"vibecode": {
	"doc": "requirements_caspian_puck_discovery_blockchain_publishing",
...
- [content-types](https://puck.uno/documentation/requirements/caspian/content-types) — the Content-Type an author's file is served with, both from the origin and from the blockchain's cache.
