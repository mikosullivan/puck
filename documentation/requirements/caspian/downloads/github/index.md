...
- [Downloads (parent)](https://puck.uno/documentation/requirements/caspian/downloads/) — the fetcher framework this plugs into.
- [Caching](https://puck.uno/documentation/requirements/caspian/downloads/caching/) — where bytes land after the fetcher returns them, and where signature verification happens.
- [Blockchain](https://puck.uno/documentation/requirements/caspian/downloads/blockchain/) — the signature source the engine uses to verify whatever this fetcher returns.
