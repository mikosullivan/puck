...
by UNS addresses like `borg.com/foo`. When a Caspian engine fetches and uses an object, it
...
out-of-order historical posts. The only rule is uniqueness within a UNS.
...
**deprecate** — marks a UNS or semver as deprecated. Does not invalidate the record;
