...
Caspian uses a single Number class for all numeric values, integer and floating-point
...
When a value falls exactly halfway between two multiples, Caspian rounds half away from
zero:
