...
- [non-caspian-mime-types](https://puck.uno/documentation/requirements/caspian/non-caspian-mime-types) — how the engine handles content types other than Caspian and CaspianJ, including the empty-content rules that apply when the cache serves a stored version back to a caller.
