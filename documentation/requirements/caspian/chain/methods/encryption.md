...
Neither sub-surface is the right tool for password hashing. Passwords have their own separate spec covering Argon2id, salt management, and verification — see the [Password class](https://puck.uno/documentation/requirements/caspian/secure-memory/password/).
