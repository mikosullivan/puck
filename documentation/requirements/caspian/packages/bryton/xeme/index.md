...
same shape underpins [Jasmine](../../jasmine/index.md) entries (Jasmine
entries are Xemes).
...
[Jasmine](../../jasmine/index.md) entries follow the Xeme format. A
...
**Status (2026-05-17): proposed, not yet applied.** [jasmine.md](../../jasmine/index.md)
