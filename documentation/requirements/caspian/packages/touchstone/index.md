...
[Sammy](sammy.md) inherits from, and that any other HTTP middleware
...
[Jasmine](../jasmine/index.md) integration, common HTTP plumbing)
...
than Touchstone itself. [Sammy](sammy.md) ships with Puck and covers
...
Touchstone wires up [Jasmine](../jasmine/index.md) logging. The ambient
...
live in core. [Sammy](sammy.md)'s path-selector registrations
...
If you want a server, instantiate [Sammy](sammy.md) — not
Touchstone directly.
