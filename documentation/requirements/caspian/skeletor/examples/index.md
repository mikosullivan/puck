...
Worked Skeletor snapshots illustrating the shape of the in-memory state hash at different moments. Each example shows a Caspian source, the runtime moment captured, and the resulting Skeletor JSON.

- [Bootstrap state](bootstrap.md) — the minimum Skeletor immediately after engine bootstrap.
...
- [Exception](exception.md) — Skeletor mid-unwind.
