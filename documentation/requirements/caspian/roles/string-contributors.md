...
~~~vibecode
{"vibecode": {
	"doc": "requirements_caspian_roles_string_contributors",
...
- [built-in-classes/primitives/string](https://puck.uno/documentation/requirements/caspian/built-in-classes/primitives/string/) — where the string surface is spec'd.
