...
~~~vibecode
{"vibecode": {
	"doc": "requirements_caspian_bryton_runner_bryton_json_files",
...
- **`true`** — run the file.
- **`false`** — do not run the file. The file will be reported as [skipped](https://puck.uno/documentation/requirements/caspian/bryton/xeme/results/#skipped).
