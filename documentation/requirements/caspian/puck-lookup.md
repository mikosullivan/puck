...
```
%puck['foo.bar/gup', ts_max: '2023-08-12']                          # only versions on or before this date
%puck['foo.bar/gup', ts_min: '2023-08-12', ts_max: '2023-09-01']    # date range
%puck['foo.bar/gup', semver_min: '1.3']                             # 1.3 or higher
%puck['foo.bar/gup', semver_min: '1.3', semver_max: '2.0']          # semver range
