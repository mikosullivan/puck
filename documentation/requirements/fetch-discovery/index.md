...
- [`%fetch`](https://puck.uno/documentation/requirements/chain/methods/puck) — the Caspian-side gateway. This page describes the fetcher array that `%fetch` walks to resolve a URL.
