...
**Related built-in method surface:** [`Array § .push` and `.import`](https://puck.uno/documentation/requirements/built-in-classes/primitives/array/#the-guaranteed-method-surface) — `<+` on an array is equivalent to `.push`.
