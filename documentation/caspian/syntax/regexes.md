...
Caspian uses Lua's built-in pattern matching by default. Lua patterns cover the common
...
quantifiers. If you need those features, restructure the logic in Caspian rather than
