...
In practice, Charlie code reaches for a Touchstone descendant rather
...
- **`$headers`** — **raw HTTP header hash.** Keys are canonical
  ...
  **Duplicate-cookie-name warning.** Before serializing,
  ...
  [jasmine/charlie.md § Automatic warning capture](../jasmine/charlie.md#automatic-warning-capture)).
