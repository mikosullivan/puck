...
```bash
./test_foo.charlie            # works
bryton.charlie ./test_foo.charlie   # also works
...
- Charlie helper library (assertion primitives, personal-config
...
- Per-language libraries beyond Charlie (Ruby, Python, JS, etc.
...
- **[Runner](runner.md)** — directory walking, bryton.json,
  ...
  precedence chain.
- **[Icons](https://github.com/mikosullivan/puck/tree/main/documentation/charlie/packages/bryton/xeme/icons/)** — the canonical icon set shipping with
  the Xeme spec.
