...
`@start_time`. No new mechanism — the standard KScript object
model carries it.
...
The default KScript behavior would let the later error shadow
...
Developers write plain strings (`'self'` as a KScript string
