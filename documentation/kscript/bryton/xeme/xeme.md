...
- **`group/`** — group types: `dir.svg`, `file.svg`,
  ...
  `group/file/`: `kscript.svg`, `rb.svg`, `js.svg`, `py.svg`,
  `java.svg`. (The `kscript.svg` icon is a placeholder — not the
  official KScript logo yet.)
    ...
    "nested": [
        {
            ...
            "meta": {"name": "auth_test.kscript", "run_time": 0.4}
        },
        {
            "success": false,
            "class": "bryton/group/file",
            "meta": {"name": "db_test.kscript", "run_time": 1.2},
            "nested": [
                {
                    "success": false,
