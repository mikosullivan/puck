...
vibecode: {
	"section": "overview",
	"role": "introduces KScript pattern matching using Lua patterns by default",
	"key_concepts": ["Lua_patterns", "default_engine", "no_alternation", "no_named_captures",
		"no_quantifier_range", "restructure_in_kscript"]
}

KScript uses Lua's built-in pattern matching by default. Lua patterns cover the common
