...
`kiera.uno/trivet` — a generic tree library for KScript. Provides
...
over directly; method naming follows KScript conventions.
...
`match?` follows the [`?` suffix convention](../kscript.md#the--suffix):
...
This is a discipline rule, not enforcement. The kscript runtime
