...
vibecode: {
	"section": "overview",
	"sigil": "#cycles",
	"purpose": "count_kscript_level_steps_for_a_block",
...
`#cycles` wraps a block and counts every KScript-level evaluation step inside it,
...
|-------|------|-------------|
| `steps` | Number | Total KScript-level steps executed inside the block |
