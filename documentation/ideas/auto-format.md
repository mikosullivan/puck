...
When KScript code is posted to a platform — a forum, a chat tool, a code review system,
...
This extends the formatter philosophy naturally: just as a developer runs `kscript fmt`
...
- Is this a platform feature or a KScript ecosystem convention?
