...
- [concepts § Lean on installed Linux utilities](https://puck.uno/documentation/requirements/concepts#lean-on-installed-linux-utilities-when-theyre-better) — the design principle this catalog serves.
- [linux-support/openssl](https://puck.uno/documentation/requirements/linux-support/openssl) and [linux-support/tar](https://puck.uno/documentation/requirements/linux-support/tar) — worked examples of the wrapper pattern.
- [core](https://puck.uno/documentation/requirements/core/) — current Cache tier and floppy budget.
