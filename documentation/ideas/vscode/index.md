...
[formatting.md](../ecoverse/formatting/index.md) plan to read
...
Open: should the extension be able to optionally read `style.json` as
a fallback or override, so a viewer who already maintains one file for
Gitter/Differ doesn't have to re-enter the same preferences in VS Code
settings? Not load-bearing for the v1 extension; defer.
