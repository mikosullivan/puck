...
**Why deferred.** The current-frame's role is available as [`%role`](https://puck.uno/documentation/requirements/roles/#role), which is the only piece of chain-frame identity most code actually needs. Full frame-walking is a heavier surface with more subtle role-boundary implications; keeping it off the V1 surface avoids committing prematurely.
