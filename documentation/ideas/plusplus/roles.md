...
{"vibecode": {
	"doc": "plusplus-roles",
	"role": "early-stage Caspian++ design for %role, a chain-scoped identity/context store distinct from access control; covers scoping, unset patterns, and privilege-escalation pitfalls",
