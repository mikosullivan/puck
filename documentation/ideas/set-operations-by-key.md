...
- [array-methods § Set operations](https://puck.uno/documentation/ideas/array-methods#set-operations) — the settled V1 set-operations surface that this kwarg would extend.
