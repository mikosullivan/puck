...
[Drinian § V1.0 scope](https://www.puck.uno/requirements/drinian/#v1-0-scope)
...
`state.new()` returns a fresh Drinian state hash. Every top-level field is
...
- **`objects`** — empty hash. Every live object's record lives here,
  ...
  [Drinian § Objects](https://www.puck.uno/requirements/drinian/objects).
- **`references`** — empty hash. Every reference-class object's pointer
  ...
  [Drinian § References](https://www.puck.uno/requirements/drinian/references).
