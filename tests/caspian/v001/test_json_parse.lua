--[[
{
  "file": "tests/caspian/v001/test_json_parse.lua",
  "test_id": "T1.1",
  "verifies": "json.parse handles the V0.01 CaspianJ fixture structure (nested arrays containing an object with a string-keyed string value, and a bare string method name)",
  "level": "unit"
}
]]
