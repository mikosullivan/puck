--[[
{
  "file": "tests/charlie/v001/test_sys_role.lua",
  "test_id": "T1.9",
  ...
  "level": "unit",
  "context": "added 2026-05-17 to close the V0.01 footprint gap surfaced in the audit; complements T1.8 (which observes the transition via Lua-level ctx.current_role) by observing it via the Charlie-side %role surface"
}
]]
