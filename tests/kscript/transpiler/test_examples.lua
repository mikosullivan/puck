--[[
{
  ...
  "covers": "smoke-tests: parse + transpile all 7 .kscript example files without error; to_json round-trip (compact and pretty)",
...
local base = "./tests/kscript/fixtures/"
...
local src_base = "./tests/kscript/fixtures/"

for _, name in ipairs(examples) do
    local path = src_base .. name .. ".kscript"
    runner.test(name .. ".kscript parses and transpiles", function()
        ...
        -- Every .kscript file has at least one statement.
