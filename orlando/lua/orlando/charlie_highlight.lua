--[[
{
  "module": "orlando.charlie_highlight",
  "role": "Tokenize Charlie source and emit HTML with pygments-compatible span classes so the pygments CSS in style.css colours it. Mirrors the token categories defined by vscode/syntax/syntaxes/charlie.tmLanguage.json; the V1 lexer is intentionally regex-grade rather than reusing charlie.lexer (which is line/col-aware and overkill for HTML markup).",
  "exports": {
    "highlight": "charlie source -> HTML string of <span class=\"...\">...</span> pieces; whitespace and unrecognized characters pass through escaped"
  },
  "classes": {
    "c1": "# line comment",
    "kc": "true / false / null",
...
--[[ { "in": {"source": "string (charlie source)"}, "out": "string (HTML with span markup)" } ]]
