...
## URL-style class identifier

Class names use URL. See [URL](../../ideas/uns/).
...
Built-in classes are recognized by the engine directly by their URL name. No records are
...
engine.validator.uns(query)           # URL class name format checks
