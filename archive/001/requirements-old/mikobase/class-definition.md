...
The class's identity is `class: "puck.uno/class"`. Its name (the URL being defined) is the `name` field. Inheritance, fields, and methods sit alongside as siblings.
