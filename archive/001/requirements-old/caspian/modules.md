...
Functions in Caspian do not capture outer scope. This means two functions defined at the
...
Every Caspian program is implicitly wrapped in a top-level module. Functions defined at
...
in Caspian. `%call.return` works inside file bodies too, for early exit.
...
- A URL name and a place in the Puckverse
...
field declarations, URL names, or the full class apparatus. The lighter syntax signals
the lighter intent.
