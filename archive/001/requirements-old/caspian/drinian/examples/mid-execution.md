...
[references.md](https://puck.uno/documentation/requirements/drinian/references)
and [garbage-collection.md](https://puck.uno/documentation/requirements/garbage-collection)).
...
- **Uspace roots are the variable objects.** `puck.uno/variable`
  ...
  [references.md § Uspace](https://puck.uno/documentation/requirements/drinian/references#uspace-class-property)),
...
- **`sequence` is `29`.** The global object-ID counter (see
  [references.md § Object IDs](https://puck.uno/documentation/requirements/drinian/references#object-ids))
...
- **Roles' buckets are empty here.** Elided for focus; see
  [bootstrap.md](https://puck.uno/documentation/requirements/drinian/examples/bootstrap)
