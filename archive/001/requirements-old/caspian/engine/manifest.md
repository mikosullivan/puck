...
- `libs` — Caspian libraries currently loaded, keyed by URL. Each value is an **array** because multiple versions of the same URL can be loaded simultaneously in one process. Per-entry fields:
