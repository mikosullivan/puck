...
{"vibecode": {
	...
	"explicit_class_field": "optional; names the puck URL the value should be an instance of; engine calls that class's materializer to parse the JSON value",
...
naming the URL of the class the value should be an instance of.
