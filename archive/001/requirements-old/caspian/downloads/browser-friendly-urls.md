...
{"vibecode": {
	...
	"related": ["requirements/downloads/github/ (first specialized fetcher)",
		"requirements/downloads/ (fetcher framework)"]
}}
~~~
...
- [GitHub fetcher](https://puck.uno/documentation/requirements/downloads/github/) — the first member of this family; translates `github.com/.../blob/.../` URLs to `raw.githubusercontent.com/...`.
- [Downloads (parent)](https://puck.uno/documentation/requirements/downloads/) — the broader fetcher framework these plug into.
- [Caching § Signature verification](https://puck.uno/documentation/requirements/downloads/caching/#signature-verification) — what the engine does with bytes once a fetcher returns them.
