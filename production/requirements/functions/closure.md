...
- **[`%chain`](https://puck.uno/archive/003/misc/chain-old/)** — the ambient capability channel, same as in bare functions and methods. Per-frame and always reachable; carries `%stdout`, `%net`, `%fetch`, and every other granted global.
