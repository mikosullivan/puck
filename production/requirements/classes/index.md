...
- [method-resolution](tag:method-resolution) — how method calls are dispatched at runtime: stack-stack walk, depth-first inheritance-graph search with per-dispatch seen-set, and how `super()` walks the class's inherits array.
