...
Stub. This section will hold per-class specs for the first-party classes Caspian promises to have available at V1 launch as fetch-on-demand downloads — not bundled with the binary, but resolvable via `%import` on first use and then cached locally.
