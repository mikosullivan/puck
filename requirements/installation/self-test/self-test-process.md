...
1. **Fetch** — load Bryton via [`%fetch`](../../chain/methods/puck), and download the test-tree tarball via [`%chain.net`](../../chain/methods/net) into a fresh [`%chain.tmp`](../../chain/methods/tmp) directory.
...
- **Bryton** — loaded via [`%fetch`](../../chain/methods/puck) in the usual way.
