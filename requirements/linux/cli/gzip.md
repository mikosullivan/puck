...
Stub. A prior sketch lives at [downloads/gzip](https://puck.uno/requirements/downloads/gzip) — it flags an unresolved Ships-tier decision (core binary vs downloadable class); this spec supersedes it once the design pass lands, regardless of tier.
...
- [downloads/gzip](https://puck.uno/requirements/downloads/gzip) — earlier stub, superseded here.
