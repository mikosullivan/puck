...
Passwords surfaced through this wrapper should route through the [Password class](https://puck.uno/requirements/protected/password) rather than being handed as plain strings on the argv (the argv is visible in `ps` for the duration of the call — a real leak).
