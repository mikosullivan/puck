...
The complement is a **faucet** — an inbound surface that pulls external values into the program. Faucets are covered separately in [faucets](https://puck.uno/requirements/plumbing/faucets/); this doc is the outbound side.
...
This is the same posture as objects generally: the runtime doesn't add a second layer of filtering on top of what the owner decided to hand across. It's the [no nanny code](https://puck.uno/requirements/concepts#no-nanny-code) principle applied to outbound.
