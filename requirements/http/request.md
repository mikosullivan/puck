...
- `%net` — the networking surface where `.fetch`, `.http_client`, `.sockets`, and `.uds` currently live. Overlap with this class's construction path is unresolved.